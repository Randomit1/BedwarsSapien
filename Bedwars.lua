...
UIGradient_12.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(190, 255, 175)), ColorSequenceKeypoint.new(0.08, Color3.fromRGB(192, 255, 178)), ColorSequenceKeypoint.new(0.28, Color3.fromRGB(202, 255, 190)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 255, 255))}
UIGradient_12.Parent = ToggleButton
...
local function NBAYL_fake_script() -- Autobuy.LocalScript 
	...
	-- Fetch the net manager path securely
	...
	-- Optimized blind-fire sequence router
	local function buy(itemName)
		...
		task.wait(0.15) -- Minimal cooling delay required to prevent server side packet dropping
	end
	...
	local function startAutoBuyLoop()
		task.spawn(function()
			while isAutoBuyEnabled do
				-- PRIORITY 1: COMBAT ARMOR
				buy("leather_chestplate")
				buy("iron_chestplate")
				buy("diamond_chestplate")
				buy("emerald_chestplate")
	
				-- PRIORITY 2: COMBAT WEAPONS
				buy("stone_sword")
				buy("iron_sword")
				buy("diamond_sword")
				buy("emerald_sword")
	
				-- FALLBACK 3: MINING PICKAXES
				buy("stone_pickaxe")
				buy("iron_pickaxe")
				buy("diamond_pickaxe")
	
				-- FALLBACK 4: BREAKING AXES
				buy("wood_axe")
				buy("stone_axe")
				buy("iron_axe")
				buy("diamond_axe")
